...
ggsave(Figure1_filename, plot = FigureOne, width = 17.78, height = 14.24, units = "cm", 
       device = "png", dpi = 600)
...
ggsave(Figure2_filename, plot = FigureTwo, width = 17.78, height = 14.24, units = "cm", 
       device = "png", dpi = 600)
```
...
![Trend in invasive cancer detection rates for Scotland, three-year rolling periods (2007/10 to 2013/16). There is a bar for each three-year rolling period.](`r Figure2_filename`) \
