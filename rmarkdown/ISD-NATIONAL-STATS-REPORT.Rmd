...
Q2BedDays <- format(Q2BedDaysBase, big.mark=",", justify="right")
Q2RateBase <- c(30.5, 9.3, 32.4, 18.0, 21.1, 19.0, 22.3, 20.6, 24.0, 29.2, 0.0, 41.6, 0.0, 33.0, 20.5, 24.3)
Q2Rate <-  format(Q2RateBase, nsmall=1, justify="right")
...
Q3BedDays <- format(Q3BedDaysBase, big.mark=",", justify="right")
Q3RateBase <- c(27.5, 30.6, 14.8, 21.0, 19.8, 39.3, 38.3, 37.7, 27.3, 24.3, 0.0, 45.6, 0.0, 31.3, 0.0, 29.8) 
Q3Rate <-  format(Q3RateBase, nsmall=1, justify="right")
...
Figure1_filename <- paste0(output_filepath, "/Figure1_ggplot.png") 
ggsave(Figure1_filename, plot = FigureOne, device = "png", dpi = 300)
...
Figure2_filename <- paste0(output_filepath, "/Figure2_ggplot.png")  
ggsave(Figure2_filename, plot = FigureTwo, device = "png", dpi = 300)
```
...
<Span custom-style = "custom2">[Introduction](#introduction)</span><Span custom-style = "My_TOC">..2</span>

<Span custom-style = "custom2">[Main Points](#main-points)</span><Span custom-style = "My_TOC">..2</span>  

<Span custom-style = "custom2">[Results and Commentary](#results-and-commentary)</span><Span custom-style = "My_TOC">..2</span>  

&ensp;&ensp;<Span custom-style = "custom2">[Sub-heading](#sub-heading)</span><Span custom-style = "My_TOC">..2</span>  

&ensp;&ensp;<Span custom-style = "custom2">[Sub-heading](#sub-heading-1)</span><Span custom-style = "My_TOC">..2</span>  

<Span custom-style = "custom2">[Glossary](#glossary)</span><Span custom-style = "My_TOC">..2</span>  

<Span custom-style = "custom2">[List of Tables](#list-of-tables)</span><Span custom-style = "My_TOC">..2</span> 

<Span custom-style = "custom2">[Contact](#contact)</span><Span custom-style = "My_TOC">..2</span>

<Span custom-style = "custom2">[Further Information](#further-information)</span><Span custom-style = "My_TOC">..2</span>  

<Span custom-style = "custom2">[Rate this publication](#rate-this-publication)</span><Span custom-style = "My_TOC">..2</span> 

<Span custom-style = "custom2">[Appendices](#appendices)</span><Span custom-style = "My_TOC">..2</span>  

&ensp;&ensp;<Span custom-style = "custom2">[Appendix 1 - Background information](#appendix-1-background-information)</span><Span custom-style = "My_TOC">..2</span> 

&ensp;&ensp;<Span custom-style = "custom2">[Appendix 2 - Publication Metadata](#appendix-2-publication-metadata)</span><Span custom-style = "My_TOC">..2</span>  

&ensp;&ensp;<Span custom-style = "custom2">[Appendix 3 - Early access details](#appendix-3-early-access-details)</span><Span custom-style = "My_TOC">..2</span>  

&ensp;&ensp;<Span custom-style = "custom2">[Appendix 4 - ISD and Official Statistics](#appendix-4-isd-and-official-statistics)</span><Span custom-style = "My_TOC">..2</span>  
...
####Figure 1: Uptake rate^1^ by NHS Board by three-year rolling period 2013-16^1,2,3,4^
...
three-year rolling periods (2007/10 to 2013/16). There is a bar for each three-year rolling period.](Figure2_ggplot.png) \
...
knitr::kable(ListofTables, col.names = c("**File name**", "**File and size**"))
```
...
knitr::kable(MetaData, col.names = c("**Metadata Indicator**", "**Description**"))
```
