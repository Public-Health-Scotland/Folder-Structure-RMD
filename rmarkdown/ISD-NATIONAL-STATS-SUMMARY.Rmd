...
output: 
  word_document:
    reference_docx: "National_Template.docx"
---
...
chart <- ggplot(data = ChartData, aes(x = Month, y = Count, group = Year, color = Year)) +
  ...
  ggtitle("Chart title")
image1_filename <- paste0(output_summary_filepath, "/chart1.png")
ggsave(image1_filename, plot = chart, device = "png", dpi = 300)
...
![Appropriate ALT Text to be added.](`r image1_filename`) \
